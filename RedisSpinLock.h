#ifndef _REDISSPINLOCK_H_
#define _REDISSPINLOCK_H_
...
{
public:
	RedisSpinLock(RedisSync& redis) : m_redis(redis) {};
	...
	// 递归锁 dic实现 支持递归
	bool RecursiveLock(const std::string& key, unsigned int millisec = 8000);
